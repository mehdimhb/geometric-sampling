...
class AStar:
    def __init__(
        ...
        *,
        ...
        if initial_design is not None:
            ...
            # if idx == 0:
            print(f"Initial design 0: efficiency z = {eff:.4f}, y={eff_y:.4f}")
        ...
        self.initial_design = self.initial_designs
        self.initial_criteria_value = var_nht
        self.initial_var_NHT = var_nht
        self.initial_var_NHT_y = var_nht_y
    ...
    def _print_best_solution(self, it, initial_efficiency_z, initial_efficiency_y, new_design, open_set):
        print(
            ...
            f"  Efficiency z (0→f):  {initial_efficiency_z} → {np.round(self.threshold_z / self.best_cost, 7)}\n"
